...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2026 at 10:58 AM
...
(171, 46, 'recipient', 'create_request', 'Recipient Recipient 4 submitted urgent blood request #51 for blood group B-.', '2026-05-06 10:55:58'),
(172, 18, 'blood_bank', 'approve_request_stock_fulfilled', 'Central Blood Bank Network reviewed request #51 and fulfilled it from stock.', '2026-05-06 11:32:58'),
(173, 46, 'recipient', 'create_request', 'Recipient Recipient 4 submitted normal blood request #52 for blood group B-.', '2026-05-06 12:54:17'),
(174, 18, 'blood_bank', 'find_donor', 'Blood bank moved request #52 to donor matching.', '2026-05-06 12:55:20'),
(175, 46, 'recipient', 'create_request', 'Recipient Recipient 4 submitted normal blood request #53 for blood group AB-.', '2026-05-07 19:17:00'),
(176, 18, 'blood_bank', 'find_donor', 'Blood bank moved request #45 to donor matching.', '2026-05-07 21:15:18'),
(177, NULL, 'donor', 'express_interest', 'Donor Donor 4 expressed interest in request #52.', '2026-05-07 21:18:18'),
(178, 18, 'blood_bank', 'select_interested_donor', 'Blood bank Central Blood Bank Network selected interested donor #45 (Donor 4) for request #52.', '2026-05-07 21:19:01'),
(179, 18, 'blood_bank', 'schedule_appointment', 'Central Blood Bank Network scheduled request-based appointment for request #52 at branch Hvidovre Branch.', '2026-05-07 21:20:25'),
(180, NULL, 'donor', 'confirm_appointment', 'Donor Donor 4 confirmed appointment #13 for request #52.', '2026-05-07 21:21:15'),
(181, NULL, 'donor', 'express_interest', 'Donor Donor 4 expressed interest in request #45.', '2026-05-07 21:21:57'),
(182, 18, 'blood_bank', 'select_interested_donor', 'Blood bank Central Blood Bank Network selected interested donor #45 (Donor 4) for request #45.', '2026-05-07 21:23:06'),
(183, 18, 'blood_bank', 'complete_donation', 'Blood bank Central Blood Bank Network completed appointment #13 for request #52 with donor Donor 4.', '2026-05-07 21:24:31'),
(184, 18, 'blood_bank', 'schedule_stock_donation', 'Blood bank scheduled or proposed a stock donation slot for stock request #12.', '2026-05-07 21:35:53'),
(185, 39, 'donor', 'confirm_stock_appointment', 'Donor Donor 3 confirmed stock donation appointment request #12.', '2026-05-07 21:37:06'),
(186, 18, 'blood_bank', 'complete_stock_donation', 'Central Blood Bank Network completed stock donation request #12 from donor Donor 3 and added 1 unit of B+ to branch stock.', '2026-05-07 21:39:06'),
(187, 10, 'admin', 'toggle_user_status', 'Admin Amir changed status of recipient user Recipient 1 (recipient1@gmail.com, ID 41) to active.', '2026-05-07 21:41:27'),
(188, 10, 'admin', 'delete_user', 'Admin Amir deleted donor user Donor 4 (donor4@gmail.com, ID 45). Reason: suspcious', '2026-05-07 21:42:10'),
(189, 10, 'admin', 'toggle_user_status', 'Admin Amir changed status of recipient user Recipient 4 (recipient4@gmail.com, ID 46) to inactive.', '2026-05-07 23:46:37'),
(190, 10, 'admin', 'toggle_user_status', 'Admin Amir changed status of recipient user Recipient 4 (recipient4@gmail.com, ID 46) to active.', '2026-05-07 23:46:45');
...
(45, 44, 'B+', 'Køge, Brøndby Strand, 2660', 'Køge', 'Brøndby Strand', '2660', 2, 'urgent', 'matched', NULL, NULL, 18, NULL, NULL, 'For CCU patient', '2026-04-30 22:04:28', NULL, 'donor', 0),
...
(51, 46, 'B-', 'Hvidovre Centrum, Hvidovre, 2650', 'Hvidovre Centrum', 'Hvidovre', '2650', 1, 'urgent', 'completed', 18, NULL, 18, '2026-05-06 13:32:58', NULL, 'Its urgent.', '2026-05-06 10:55:58', 4, 'stock', 1),
(52, 46, 'B-', 'Hvidovre 158, Hvidovre, 2650', 'Hvidovre 158', 'Hvidovre', '2650', 1, 'normal', 'completed', NULL, NULL, 18, NULL, NULL, '', '2026-05-06 12:54:17', 4, 'donor', 0),
(53, 46, 'AB-', 'Hvidovre Centrum, Hvidovre, 2650', 'Hvidovre Centrum', 'Hvidovre', '2650', 2, 'normal', 'pending_review', NULL, NULL, 18, NULL, NULL, 'For My Father.', '2026-05-07 19:17:00', NULL, 'none', 0);
...
(19, 39, 18, NULL, '2026-05-07', '2026-05-08 23:34:00', '2026-05-07 23:39:06', '[Blood Bank Schedule Note]', 'confirmed', 2, 'stock_donation');
...
(188, 18, 'A donor has confirmed the scheduled donation appointment.', 1, '2026-05-03 21:42:02'),
...
(198, 18, 'A donor confirmed the scheduled stock donation appointment (#1).', 1, '2026-05-03 22:58:02'),
(199, 18, 'A donor has confirmed the scheduled donation appointment for request #25.', 1, '2026-05-03 22:58:19'),
...
(202, 18, 'Donor Donor 2 expressed interest in blood request #48.', 1, '2026-05-03 23:01:00'),
(203, 18, '[URGENT] Emergency blood request submitted. Request #51 needs immediate review.', 1, '2026-05-06 10:55:58'),
(204, 46, 'Your blood request has been reviewed and fulfilled from available stock at Hvidovre Branch.', 0, '2026-05-06 11:32:58'),
(205, 18, 'A new blood request has been submitted and is waiting for review.', 1, '2026-05-06 12:54:17'),
(206, 46, 'Your blood request #52 has been approved for donor matching.', 0, '2026-05-06 12:55:20'),
(207, 18, 'A new blood request has been submitted and is waiting for review.', 1, '2026-05-07 19:17:00'),
(208, 44, 'Your blood request #45 has been approved for donor matching.', 0, '2026-05-07 21:15:18'),
(209, 18, 'Donor Donor 4 expressed interest in blood request #52.', 1, '2026-05-07 21:18:18'),
(211, 46, 'Your blood request #52 has been matched with an interested donor by the blood bank.', 0, '2026-05-07 21:19:01'),
(213, 46, 'Your blood request has been scheduled at Hvidovre Branch on 2026-05-08T12:20.', 0, '2026-05-07 21:20:25'),
(214, 18, 'A donor has confirmed the scheduled donation appointment for request #52.', 1, '2026-05-07 21:21:15'),
(215, 18, 'Donor Donor 4 expressed interest in blood request #45.', 1, '2026-05-07 21:21:57'),
(217, 44, 'Your blood request #45 has been matched with an interested donor by the blood bank.', 0, '2026-05-07 21:23:06'),
(219, 46, 'Your blood request #52 has been fulfilled and marked as completed by the blood bank.', 0, '2026-05-07 21:24:31'),
(220, 39, 'A stock donation appointment has been scheduled for request #12 on 2026-05-08T23:34.', 0, '2026-05-07 21:35:53'),
(221, 18, 'A donor confirmed the scheduled stock donation appointment (#12).', 0, '2026-05-07 21:37:06'),
(222, 39, 'Your stock donation has been marked as completed. You are temporarily unavailable for donation. Next Eligible Date: 2026-08-07.', 0, '2026-05-07 21:39:06'),
(223, 18, 'New stock donation request #14 from Donor 2 (A-) for Hvidovre Branch. Preferred date: 2026-05-08T15:40.', 0, '2026-05-08 08:43:16'),
(224, 43, 'Your stock donation request #14 has been submitted and is waiting for blood bank scheduling.', 0, '2026-05-08 08:43:16');
...
CREATE TABLE `stock_donation_requests` (
  `id` int(11) NOT NULL,
  `donor_id` int(11) NOT NULL,
  `blood_bank_user_id` int(11) NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
...
(12, 39, 18, 2, '2026-05-08 23:34:00', '2026-05-08 23:34:00', '2026-05-07 23:39:06', 'Stock donation completed by Central Blood Bank Network on 2026-05-07 23:39:06.', '[Blood Bank Schedule Note]', 'completed', '2026-05-07 21:35:01'),
(13, 43, 18, 1, '2026-05-09 12:30:00', NULL, NULL, NULL, '', 'pending', '2026-05-08 08:27:18'),
(14, 43, 18, 4, '2026-05-08 15:40:00', NULL, NULL, NULL, '', 'pending', '2026-05-08 08:43:16');
...
(21, 'Hamja', 'hamja@gmail.com', '+4555277257', NULL, '1997-11-04', NULL, '$2y$10$/XuQw/gP/tyfcrElLWPAIe6iREKOGXGFfWRjyuz8bWCn.VfKLXvUi', 'donor', 'O+', 80.00, 'Norrebro', NULL, NULL, NULL, NULL, 'not_available', '2026-03-24 00:24:39', 'active', 'active', '2026-07-30'),
...
(26, 'Sam', 'sam@gmail.com', '55277111', NULL, '1997-05-05', NULL, '$2y$10$myk3eKOnH/qu0OgG6K5Fpue0WLZvOGr7qSzb9IrcSJMyLpbzF5duy', 'donor', 'AB-', 68.00, 'Norrebro, Copenhagen, 2300', 'Norrebro', 'Copenhagen', '2300', NULL, 'not_available', '2026-04-12 17:58:28', 'active', 'active', '2026-07-17'),
...
(39, 'Donor 3', 'donor3@gmail.com', '12323454', NULL, '2003-11-23', NULL, '$2y$10$38zW82fP2qnxQ14pY8YQnu4gGatCrECsvINwW4M2drodBCxLgmHHe', 'donor', 'B+', 70.00, 'Gammel Køge, Brøndby Strand, 2660', 'Gammel Køge', 'Brøndby Strand', '2660', NULL, 'not_available', '2026-04-29 20:38:29', 'active', 'active', '2026-08-07'),
...
(41, 'Recipient 1', 'recipient1@gmail.com', '', NULL, NULL, NULL, '$2y$10$s8d3Fr7rZdEBnLZbzc7FqOGYWjvipZz3srISaEbqbQDT6nBJA8xmi', 'recipient', 'A+', NULL, 'Lundtoftegade, copenhagen, 2100', 'Lundtoftegade', 'copenhagen', '2100', NULL, 'available', '2026-04-29 20:46:39', 'active', 'active', NULL),
...
(46, 'Recipient 4', 'recipient4@gmail.com', '+459087609', NULL, NULL, NULL, '$2y$10$5ipI3kQ.SsM3U8/4reg6M.lW/mgPWHDU4EUdPuoMDqjRHR0uslqr6', 'recipient', 'B-', NULL, 'Hvidovre, Hvidovre, 2650', 'Hvidovre', 'Hvidovre', '2650', NULL, 'available', '2026-05-06 10:53:03', 'active', 'active', NULL);
...
ALTER TABLE `appointments`
  ...
  ADD KEY `fk_appointments_recipient` (`recipient_id`),
  ADD KEY `fk_appointments_blood_bank` (`blood_bank_id`),
...
ALTER TABLE `blood_requests`
  ...
  ADD KEY `fk_blood_requests_fulfilled_branch` (`fulfilled_branch_id`);
...
ALTER TABLE `blood_stock`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_branch_blood_group` (`branch_id`,`blood_group`);
...
ALTER TABLE `branches`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_branches_blood_bank_user` (`blood_bank_user_id`);
...
ALTER TABLE `donations`
  ...
  ADD KEY `fk_donations_blood_bank` (`blood_bank_id`),
...
--
-- Indexes for table `stock_donation_requests`
--
ALTER TABLE `stock_donation_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_stock_donation_requests_donor` (`donor_id`),
  ADD KEY `fk_stock_donation_requests_blood_bank` (`blood_bank_user_id`),
  ADD KEY `fk_stock_donation_requests_branch` (`branch_id`);
...
--
-- AUTO_INCREMENT for table `stock_donation_requests`
--
ALTER TABLE `stock_donation_requests`
