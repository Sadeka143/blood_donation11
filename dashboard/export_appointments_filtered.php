...
if(!in_array($appointment_type, $allowed_type)) $appointment_type = 'all';
...
if($donor_search !== ""){
    ...
    $sql .= " AND d.name LIKE '%$donor_safe%'";
}
...
if($location_search !== ""){
    ...
    $sql .= " AND (
        a.appointment_location LIKE '%$location_safe%' OR
        a.appointment_address LIKE '%$location_safe%' OR
        a.appointment_city LIKE '%$location_safe%' OR
        a.appointment_zipcode LIKE '%$location_safe%'
    )";
}
